  ...
  describe 'Techcrunch' do
    ...
    describe 'Good link' do
      ...
      it 'responds to title' do
        techcrunch.respond_to?(:title).should eql true
      end

      it 'responds to body' do
        techcrunch.respond_to?(:body).should eql true
      end

      it 'responds to as_hash' do
        techcrunch.respond_to?(:as_hash).should eql true
      end

      it 'responds to as_json' do
        techcrunch.respond_to?(:as_json).should eql true
      end
    ...
    describe 'Bad link' do
      ...
      it 'has the right class name' do
        expect { techcrunch }.to raise_error(StandardError, 'Error while fetching the link. Status: not 200')
      end
    end
    ...
    describe 'Not related link' do
      ...
      it 'has the right class name' do
        expect { techcrunch }.to raise_error(StandardError, 'Couldn\'t fetch your link through this class!')
      end
    end
